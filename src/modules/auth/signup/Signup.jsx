...
export default function Signup() {
    ...
    const { email, password, firstName, lastName, loading, needsEmailConfirmation, msgError } = state;
    ...
    const handleSignupNewUser = async (e) => {
        ...
        try {
            await dispatch(handleSignUp({ email, password, firstName, lastName })).unwrap();
    ...
    return (
        <form onSubmit={handleSignupNewUser} className="auth">
            <div className="auth-header">
                ...
                <p className="txt-sm txt-gray mt-1">{t('create_account_description')}</p>
            </div>
            ...
            <div className="auth-content">
                <div className="flexcenter align-top gap-6">
                    <div className="flex-column flex-1 gap-6">
                        ...
                        <div>
                            ...
                            {msgError.firstName && <p className="txt-incorrect">{msgError.firstName}</p>}
                        </div>
                    </div>
                ...
                <button type="submit" className="btn-default w-100 btn-main fs-3 h-8 justify-center">
