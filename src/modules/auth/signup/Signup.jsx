...
export default function Signup() {
  ...
  const checkValidForm = () => {
    ...
    if (!firstName) {
      errors.firstName = t("auth:first_name_required");
    }
  ...
  return (
    <form onSubmit={handleSignupNewUser} className="auth">
      <div className="auth-header">
        <h3 className="title-label">{t("auth:create_account")}</h3>
      ...
      <div className="auth-content">
        <div className="flexcenter align-top gap-6">
          <div className="flex-column flex-1 gap-6">
            <p className="txt-sm">{t("auth:first_name")}</p>
            <div>
          ...
          <div className="flex-column flex-1 gap-6">
            <p className="txt-sm">{t("auth:last_name")}</p>
            <div className="relative">
              <input
                name="lastName"
                type="text"
